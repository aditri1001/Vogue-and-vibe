        ...
        <>
            ...
            <section className="w-full mt-32  bg-gray-100 ">
                <div className="w-full h-full items-center flex justify-center flex-col gap-7">
                    ...
                    <div className="  px-20  ">
                        <div className="w-full h-1/2">
                            <img
                                src="src/assets/images/sectionPage/png10.jpeg"
                                alt="Magazine Cover"
                ...
                <div className="w-full h-full flex items-center  justify-center  gap-7 mt-32 px-20">
                    <div className="mr-5 ">
                        <img
                            src="src/assets/images/sectionPage/png11.jpeg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                    <div className="w-1/2">
                        <img
                            src="src/assets/images/sectionPage/png12.jpeg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                </div>
                <div className="w-full h-full flex   justify-center  gap-7 mt-32 px-20">
                    <div className="mr-5 w-4/5">
                        <img
                            src="src/assets/images/sectionPage/png13.gif"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                    <div className="w-2/5">
                        <img
                            src="src/assets/images/sectionPage/png14.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                </div>
                <div className="w-full h-full flex items-center  justify-center  gap-7  px-20">

                    <div className="w-1/3">
                        <img
                            src="src/assets/images/sectionPage/png15.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                    <div className="mr-5 w-1/2">
                        <img
                            src="src/assets/images/sectionPage/png16.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                ...
                <div className="w-full h-full flex items-center  justify-center  gap-7  px-20">
                    <div className="mr-5 w-3/5">
                        <img
                            src="src/assets/images/sectionPage/png17.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                    <div className="w-1/3">
                        <img
                            src="src/assets/images/sectionPage/png18.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                ...
                <div className="w-full h-full flex items-center   justify-center  gap-7 mt-32 px-20">
                    ...
                    <div className="w-1/3">
                        <img
                            src="src/assets/images/sectionPage/png20.jpg"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                    <div className="mr-5 w-1/2">
                        <img
                            src="src/assets/images/sectionPage/png19.gif"
                            alt="Magazine Cover"
                            className="w-full h-auto object-cover shadow-lg"
                        />
                    </div>
                ...
                <button className='bg-black   text-white w-1/12 m-auto py-2 mt-12 rounded-3xl' type="submit">More</button>     
            </section>
        </>
    );
}
